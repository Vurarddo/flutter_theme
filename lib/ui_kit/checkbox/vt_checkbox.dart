...
class VTCheckbox extends StatefulWidget {
  ...
  @override
  _VTCheckboxState createState() => _VTCheckboxState();
}

class _VTCheckboxState extends State<VTCheckbox> with TickerProviderStateMixin, ToggleableStateMixin {
  ...
  @override
  void didUpdateWidget(VTCheckbox oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final Color effectiveCheckColor =
        widget.checkColor ?? themeData.checkboxTheme.checkColor?.resolve(states) ?? VTColors.vtSilverColor;
...
const double _kEdgeSize = VTCheckbox.width;
